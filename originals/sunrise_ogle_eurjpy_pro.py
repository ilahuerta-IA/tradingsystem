"""Advanced Sunrise OGLE Strategy - EURJPY Production (Long-Only)
================================================================
EURJPY OPTIMIZED VERSION - Parameters tuned for JPY pair characteristics.
...
- EURJPY - 0.01 pip value, 3 decimals, JPY P&L conversion
...
# EURJPY - JPY pair with 0.01 pip value and 3 decimal places
DATA_FILENAME = 'EURJPY_5m_5Yea.csv'

# === BACKTEST SETTINGS ===
FROMDATE = '2024-07-01'               # Start date for backtesting (YYYY-MM-DD)
...
FOREX_INSTRUMENT = 'EURJPY'           # JPY pair
...
LONG_ATR_MIN_THRESHOLD = 0.030               
LONG_ATR_MAX_THRESHOLD = 0.090               

# ATR INCREMENT FILTER 
LONG_USE_ATR_INCREMENT_FILTER = False         
LONG_ATR_INCREMENT_MIN_THRESHOLD = 0.0    
...
LONG_MIN_ANGLE = 45.0                         # Minimum angle in degrees
LONG_MAX_ANGLE = 95.0                        # Maximum angle in degrees
...
ENTRY_START_HOUR = 5                         # Start hour (UTC) - Asia late session
ENTRY_START_MINUTE = 0                       # Start minute
ENTRY_END_HOUR = 18                          # End hour (UTC) - End of London session
ENTRY_END_MINUTE = 0                         # End minute (01:00-15:00 UTC)

# === RISK MANAGEMENT ===
ATR_LENGTH = 10                              # ATR calculation period
LONG_ATR_SL_MULTIPLIER = 3.5                 # SL = ATR x 3.5 (Phase 1 BEST: PF=1.20)
...
class SunriseOgle(bt.Strategy):
    params = dict(
        ...
        ema_fast_length=18,              # Phase 3 BEST: PF=1.13
        ema_medium_length=18,            # Phase 3 BEST: +$3,621
        ema_slow_length=24,              # Phase 3 BEST: DD=3.9%
        ema_confirm_length=1,            # Confirmation EMA (usually 1 for immediate response)
        ema_filter_price_length=70,      # Phase 3 BEST: Filter EMA
