"""Advanced Sunrise Strategy - TLT ETF Trading System (LONG-ONLY)
================================================================
LONG-ONLY VERSION: This is a cleaned and optimized version focused exclusively on TLT ETF LONG trading.
All SHORT trading functionality has been removed for simplicity and focus.

This strategy implements a sophisticated LONG-only trading system optimized for TLT ETF with the following features:
...
CONFIGURATION: Instrument settings optimized for TLT ETF
     - Pip values: 0.01
...
DATA_FILENAME = 'TLT_5m_5Yea.csv'     # TLT ETF 5-minute data
...
# =============================================================================
# ETF CONFIGURATION (TLT)
# =============================================================================
IS_ETF = True                         # Enable ETF mode
ETF_INSTRUMENT = 'TLT'                # TLT ETF
...
LONG_ATR_MIN_THRESHOLD = 0.05               # DIA typical ATR min (~$0.20)
LONG_ATR_MAX_THRESHOLD = 0.21               # DIA typical ATR max (~$0.50)
...
LONG_USE_ANGLE_FILTER = True                # DISABLED: Phase 8 showed overfitting
...
class SunriseOgle(bt.Strategy):
    params = dict(
        ...
        long_atr_tp_multiplier=8.0,                           # Phase 1 OPTIMAL: 15.0x ATR
        ...
        risk_percent=0.01,               # Risk 1% of account per trade (conservative for ETFs)
