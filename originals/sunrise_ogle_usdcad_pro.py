"""Advanced Sunrise OGLE Strategy - USDCAD PRO (Long-Only)
============================================================
OPTIMIZED CONFIGURATION FOR USDCAD
Optimization Date: December 2025

RESULTS (5 years: 2020-2025):
- Trades: 127 | Win Rate: 32.3%
- Profit Factor: 1.73
- Net PnL: $24,031
- Max Drawdown: 5.6%
...
FOREX_INSTRUMENT = 'USDCAD'           # USDCAD optimized
...
COMMISSION_PER_LOT_PER_ORDER = 2.50   # USD per lot per order (Darwinex Zero)
SPREAD_PIPS = 1.5                     # USDCAD typical spread
...
# =============================================================================
INSTRUMENT_CONFIGS = {
    'USDCAD': {'pip_value': 0.0001, 'pip_decimal_places': 5, 'lot_size': 100000, 'atr_scale': 1.0, 'is_jpy': False, 'spread': 1.5},
...
# === LONG ATR VOLATILITY FILTER (USDCAD: DISABLED - reduces trades below 120) ===
LONG_USE_ATR_FILTER = False                  # DISABLED for USDCAD
LONG_ATR_MIN_THRESHOLD = 0.000150            # Not used
LONG_ATR_MAX_THRESHOLD = 0.000450            # Not used
...
# === LONG ENTRY FILTERS (USDCAD OPTIMIZED - Phase 6A) ===
...
LONG_USE_ANGLE_FILTER = True                 # ENABLED for USDCAD (Phase 6A)
LONG_MIN_ANGLE = 45.0                        # Optimized: 45° minimum
LONG_MAX_ANGLE = 75.0                        # Optimized: 75° maximum
...
# === LONG PULLBACK ENTRY SYSTEM (USDCAD BASELINE) ===
LONG_USE_PULLBACK_ENTRY = True               # Enable pullback entry system
LONG_PULLBACK_MAX_CANDLES = 2                # Max red candles in pullback
LONG_ENTRY_WINDOW_PERIODS = 1                # Entry window bars

# --- VOLATILITY EXPANSION CHANNEL - KEY TIMING PARAMETERS ---
USE_WINDOW_TIME_OFFSET = False               # Immediate window opening
WINDOW_OFFSET_MULTIPLIER = 1.0               # Window delay multiplier
WINDOW_PRICE_OFFSET_MULTIPLIER = 0.01        # Price expansion multiplier

# === TIME RANGE FILTER (USDCAD OPTIMIZED: 18:00-12:00 UTC - Phase 6B) ===
USE_TIME_RANGE_FILTER = True                 # ENABLED for USDCAD
ENTRY_START_HOUR = 18                        # Start hour (UTC) - Evening session
ENTRY_START_MINUTE = 0                       # Start minute
ENTRY_END_HOUR = 12                          # End hour (UTC) - Next day noon
ENTRY_END_MINUTE = 0                         # End minute

# === RISK MANAGEMENT (USDCAD OPTIMIZED - Phase 1) ===
ATR_LENGTH = 10                              # ATR calculation period
LONG_ATR_SL_MULTIPLIER = 3.0                 # SL = ATR x 3.0
LONG_ATR_TP_MULTIPLIER = 15.0                # TP = ATR x 15.0 (R:R = 1:5)
...
class SunriseOgle(bt.Strategy):
    params = dict(
        # === TECHNICAL INDICATORS (USDCAD OPTIMIZED - Phase 3) ===
        ema_fast_length=24,              # Fast EMA (USDCAD optimized)
        ema_medium_length=30,            # Medium EMA (USDCAD optimized)
        ema_slow_length=36,              # Slow EMA (USDCAD optimized)
        ema_confirm_length=1,            # Confirmation EMA
        ema_filter_price_length=40,      # Price filter EMA (USDCAD optimized)
        ...
        long_atr_sl_multiplier=LONG_ATR_SL_MULTIPLIER,    # SL multiplier (USDCAD: 3.0)
        long_atr_tp_multiplier=LONG_ATR_TP_MULTIPLIER,    # TP multiplier (USDCAD: 15.0)
