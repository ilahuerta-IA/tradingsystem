...
ASSET_PROFILES = {
    ...
    'XLE': {
        ...
        'to_date': datetime(2023, 12, 31),
        'ranges': {
            # XLE: Z +3.05 @5m, 56% bull bias, HOT peak 13:30 UTC (NYSE open)
            # NYSE open 14:30 winter / 13:30 summer -> SsH 13-14 with nyse DST
            # No valley (ETF closes overnight) -> consolidation = first N bars
            'session_start_hour': (13, 14, 1),
            'base_timeframe_minutes': [5],
            'consolidation_bars_min': {
                5: (2, 8, 3),
            },
    ...
    'XLU': {
        ...
        'to_date': datetime(2023, 12, 31),
        'ranges': {
            # XLU: Z +3.09 @5m, 62% bull bias (strongest), HOT peak 13:30 UTC
            # Same NYSE structure as XLE
            'session_start_hour': (13, 14, 1),
            'base_timeframe_minutes': [5],
            'consolidation_bars_min': {
                5: (2, 8, 3),
